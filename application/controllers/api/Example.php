...
class Example extends \Restserver\Libraries\REST_Controller {
    ...
    public function users_get() {
        ...
        $users = [
            ...
            ['id' => 3, 'name' => 'Edgar', 'email' => 'edgar@example.com', 'fact' => 'Developed on CodeIgniter'],
            ['id' => 4, 'name' => 'Jane', 'email' => 'jane@example.com', 'fact' => 'Lives in the USA', ['hobbies' => ['guitar', 'cycling']]
            ],
        ];
